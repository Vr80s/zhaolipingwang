					...
					<div class="panel-body">
						...
						<div class="tab-content">
							<div id="base" class="tab-pane active">
								...
								[/#if]
                                <div class="form-group">
                                    <label class="col-xs-3 col-sm-2 control-label item-required" for="minimumPurchase">${message("business.product.minimumPurchase")}:</label>
                                    <div class="col-xs-9 col-sm-4" title="${message("business.product.minimumPurchase")}" data-toggle="tooltip">
                                        <input id="minimumPurchase" name="minimumPurchase" class="form-control" value="${product.minimumPurchase}" type="text" maxlength="16">
                                    </div>
                                </div>
								<div class="form-group">
