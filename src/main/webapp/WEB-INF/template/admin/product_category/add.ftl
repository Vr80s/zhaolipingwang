				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="form-group" style="display: none">
							...
							<div class="col-xs-9 col-sm-4">
								<div class="input-group">
									<input id="generalRate" name="generalRate" class="form-control" value="0" type="text" maxlength="9">
						...
						<div class="form-group" style="display: none">
							...
							<div class="col-xs-9 col-sm-4">
								<div class="input-group">
									<input id="selfRate" name="selfRate" class="form-control" value="0" type="text" maxlength="9">
									<span class="input-group-addon">%</span>
								</div>
							</div>
						</div>
