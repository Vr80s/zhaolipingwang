									...
									<div class="input-group-btn">
										<button class="btn btn-default" type="button" data-toggle="dropdown">
											[#switch page.searchProperty]
												[#case "mobile"]
													<span>${message("Business.mobile")}</span>
													[#break /]
												[#default]
										...
										<ul class="dropdown-menu">
											...
											<li[#if page.searchProperty == "mobile"] class="active"[/#if] data-search-property="mobile">
												<a href="javascript:;">${message("Business.mobile")}</a>
											</li>
										</ul>
									</div>
							...
							<table class="table table-hover">
								<thead>
									<tr>
										...
										<th>
											<a href="javascript:;" data-order-property="attributeValue0">
												${message("Business.UnifiedSocialCreditcode")}
												<i class="iconfont icon-biaotou-kepaixu"></i>
											</a>
										</th>
										<th>
									...
									<tbody>
										[#list page.content as business]
											<tr>
												...
												<td>${business.attributeValue0}</td>
